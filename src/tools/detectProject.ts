...
export async function detectProject(filePath: string): Promise<ProjectInfo> {
...
export function getRecommendedFramework(projectInfo: ProjectInfo): 'jest' | 'karma' | 'jasmine' {
